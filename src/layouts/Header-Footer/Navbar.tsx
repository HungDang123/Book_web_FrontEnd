...
const Navbar: React.FC<NavbarProps> = ({ keySearch, setKeySearch }) => {
                ...
                <div className="top-bar mouse-hover">
                    ...
                    <div className="top-bar-search-container">
                        <div className="top-bar-search">
                            ...
                            }}><span className="top-bar-search-icon"></span></span>
                        ...
                        <div className="top-bar-search-info">
                            ...
                            <div className="tu-khoa-hot-container">
                                {listBook.map((book: Book) => (
                                    <SearchProps key={book.id} book={book}></SearchProps>
                                ))}
                            </div>
                    ...
                    <div className="center_center mouse-hover top-notif ">
                        ...
                        <div className="top-dropdown">
                            ...
                            <button style={{ marginTop: '5px' }} type="button" className="button-default a">
                                <span>Đăng nhập</span>
                            </button>
                    ...
                    <div className="center_center mouse-hover top-account">
                        <a className="top-button-icon">
                            ...
                            <div className="center_center">
                                <div className="top_menu_label" onClick={()=>{
