            ...
            <form className="my-form">
                ...
                <div className="socials-row">
                    <a href="#" title="Use Google">
                        <img src="https://goodies.icons8.com/web/common/social/social_google.svg" alt="Google" />Use Google
                    </a>
                    <a href="#" title="Use Apple" onClick={handleFbLogin}>
                        <img src="https://goodies.icons8.com/web/common/social/social_facebook.svg" alt="Facebook"/> Use Facebook
                    </a>
                </div>
